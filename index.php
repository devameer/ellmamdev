...
<div class="home-header">
    <div class="big-shape" id="big-shape"></div>
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="vector" id="vectorOne">
                    <img src="/assets/images/Consultative sales-amico (1).svg" alt="" />
                </div>
            </div>
        </div>
    </div>
...
<div class="inner-page contact pt-5">
    <div class="container">
        <div class="sec-title" data-aos="flip-down">
